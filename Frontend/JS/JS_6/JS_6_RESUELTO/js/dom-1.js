...
//console.log("nombre", nombreIngresado);// No muestra nada porque no hemos creado el evento
...
// declarar la variable charCode = nombre.charCodeAt(i);
        ...
        // permite digitar sólo texto, letras mayúsculas (del 65 al 90)
        // y minúsculas (del 97 al 122)
...
boton.addEventListener("click", ()=>{
        ...
        //console.log("nombre", nombreIngresado) // muestra la etiqueta
       ...
       for(let i=0; i<nombre.length; i++){
                ...
                if(nombre!="" && ((codigo>=65 && codigo<=90) || (codigo>=97 && codigo<=122))){
                        ...
                        alert("El nombre no puede tener números o carácteres especiales.")
                }else{
